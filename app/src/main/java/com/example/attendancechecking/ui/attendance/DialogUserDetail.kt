...
class DialogUserDetail(private val user: User) : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        view.findViewById<TextView>(R.id.dialogUserTime).text = "$displayHour:$displayMinute"
        view.findViewById<TextView>(R.id.dialogUserTime).setTextColor(if(user.type == "Check-in") resources.getColor(
            R.color.green
